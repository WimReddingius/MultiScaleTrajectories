...
{
    static class ShortcutFinderOld
    {

        public static ShortcutSet<MaxDistanceShortcut> FindAllMaxDistanceShortcuts(Trajectory2D trajectory)
        {
        ...
        public static ShortcutSet<Shortcut> FindShortcuts(Trajectory2D trajectory, double epsilon)
        {
