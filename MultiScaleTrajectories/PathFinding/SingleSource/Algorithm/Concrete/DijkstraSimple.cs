...
{
    class DijkstraSimple<TNode, TEdge> : SingleSourceShortestPath<TNode, TEdge> where TNode : Node, new() where TEdge : Edge
    {
        public override string AlgoName => "Dijkstra - Simple";
